...
use app\modules\admin\models\ChatRestrictionSearch;
...
class ChatRestrictionController extends Controller
{
    ...
    /**
     * Creates a new ChatRestriction model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new ChatRestriction();
    ...
    /**
     * Deletes an existing ChatRestriction model.
